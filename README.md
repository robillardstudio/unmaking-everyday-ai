...
Two different types of parameters are given: string (word), value (word frequency). The table below summarizes the analysis. The Colab notebook used for the text mining is also shared [here](drs-method.ipynb).
...
| Zoom    | [https://www.zoom.com/en/products/ai-assistant/resources/privacy-security/#zoom-ai-companion](https://www.zoom.com/en/products/ai-assistant/resources/privacy-security/#zoom-ai-companion) | 18536                    | 1638                       | 568                | companion, zoom, thirdparty, feature, customer |
